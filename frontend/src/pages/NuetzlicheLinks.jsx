        ...
        <div className="rounded-3xl bg-white/85 border border-gray-200 shadow-sm overflow-hidden">
          ...
          <div className="divide-y divide-gray-200">
            {links.map((l) => (
              ...
              >
                <div
                  className={`mt-0.5 w-11 h-11 rounded-2xl bg-gradient-to-tr ${l.accent}
                ...
                <div className="shrink-0 mt-1">
                  <span className="material-symbols-outlined text-[22px] text-gray-300
                                   transition-all group-hover:text-gray-700 group-hover:translate-x-1">
                    chevron_right
                  </span>
                </div>
              </a>
